...
import { chainPropTypes, getDisplayName } from '@qodev/utils';
  ...
  const withTheme = Component => {
    ...
    process.env.NODE_ENV !== "production" ? WithTheme.propTypes = {
      ...
      innerRef: chainPropTypes(PropTypes.oneOfType([PropTypes.func, PropTypes.object]), props => {
        ...
        return new Error('Qodev-UI: The `innerRef` prop is deprecated and will be removed in v5. ' + 'Refs are now automatically forwarded to the inner component.');
      })
    } : void 0;
